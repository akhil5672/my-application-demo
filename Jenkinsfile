node {
   ...
   stage ('DEV Deploy')  {
      ...
      deploy adapters: [tomcat9(credentialsId: '452e77a1-3214-4231-8469-63591565d19c', path: '', url: 'http://3.142.251.241:8080')], contextPath: null, war: '**/*.war'
